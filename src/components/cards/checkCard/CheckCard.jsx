        ...
        <div className={cn(styles.card,{
            ...
            <div className={styles.content}>
                <div className={styles.wrapper}>
                    <h3 className={cn(styles.title, isReversed ? styles.titleRight : styles.titleLeft)}>{title}</h3>
                    <p className={cn(styles.absolute, isReversed ? styles.absoluteRight : styles.absoluteLeft)}>{number}</p>
                </div>
                <p className={cn(styles.text, isReversed ? styles.textRight : styles.textLeft)}>{text}</p>
            </div>
